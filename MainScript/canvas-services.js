...
function onDown(ev) {
  ...
  let pos = getEvPos(ev)
 var selectedIdx= gMeme.lines.findIndex(line=>{  // where clicked  {x start img<x> x end img}  {x start img<x> x end img}
   return (pos.x>line.coord.x&&pos.x<line.coord.xEnd&&
    pos.y>line.coord.y&&pos.y<line.coord.yEnd)
